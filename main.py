...
dog.addTask(Task(name="Morning walk", duration=30, priority=3, type="exercise"))
dog.addTask(Task(name="Feed breakfast", duration=10, priority=5, type="feeding"))
cat.addTask(Task(name="Litter box cleaning", duration=15, priority=4, type="hygiene"))
